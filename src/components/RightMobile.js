...
const panes = [
  { menuItem: 'Day 1', render: () => 
    <Tab.Pane className="mobile-agenda">
...
class RightMobile extends Component {
    render() {
        return (
            <section className="right-mobile">
                <div>
