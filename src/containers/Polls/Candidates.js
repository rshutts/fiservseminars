...
export default function Candidates({ poll, candidates, onUpVote, simulateUpvotes, pollView = false }) {
  ...
  const Vote1 = () => {
    return <FaArrowCircleUp style={{ fill: '#ff00e4'}}/>;
  };
  
  const Vote2 = () => {
    return <FaArrowCircleUp style={{ fill: '#0090ff'}}/>;
  };
  
  const Vote3 = () => {
    return <FaArrowCircleUp style={{ fill: '#8c41f0'}}/>;
  };

  const Vote4 = () => {
    return <FaArrowCircleUp style={{ fill: '#ff6600'}}/>;
  };

  const Vote5 = () => {
    return <FaArrowCircleUp style={{ fill: '#ffffff'}}/>;
  };
                ...
                <div className="mt-4 flex items-center" key={candidate.id}>
                  ...
                  <div className="w-12 md:w-18">
                    ...
                    {(() => {
                      if (index === Number(0)) {
                        return (
                          <p className="w-20 text-4xl font-bold ml-3" style={{ color: "#ff00e4"}}>{candidate.upvotes}</p>
                        )
                      } else if (index === Number(1)) {
                        return (
                          <p className="w-20 text-4xl font-bold ml-3" style={{ color: "#0090ff"}}>{candidate.upvotes}</p>
                        )
                      } else if (index === Number(2)) {
                        return (
                          <p className="w-20 text-4xl font-bold ml-3" style={{ color: "#8c41f0"}}>{candidate.upvotes}</p>
                        )
                      } else if (index === Number(3)) {
                        return (
                          <p className="w-20 text-4xl font-bold ml-3" style={{ color: "#ff6600"}}>{candidate.upvotes}</p>
                        )
                      }
                      else {
                        return (
                          <p className="w-20 text-4xl font-bold ml-3" style={{ color: "#ffffff"}}>{candidate.upvotes}</p>
                        )
                      }
                    })()}
                  </div>
