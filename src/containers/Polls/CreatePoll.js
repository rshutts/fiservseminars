  ...
  async function createPoll() {
    ...
    */
    ...
    try {
      ...
      await Promise.all([createPollPromise, createCandidate1Promise, createCandidate2Promise, createCandidate3Promise])
        ...
        pollType === 'image' && (
          <div className="mt-8">
            ...
            <div className="mt-6">
              ...
              <p className="mb-4 mt-6 font-bold">What is the third option?</p>
              {
                state.candidate3 && (
                  <img
                    src={state.candidate3.localFile}
                    style={imageStyle}
                  />
                )
              }
              <div>
                <input
                  ...
                  onChange={onChangeImage}
                />
                <label htmlFor="file3" style={inputLabelStyle}>Choose a file</label>
              </div>
              <p className="mb-4 mt-6 font-bold">What is the fourth option?</p>
              {
                state.candidate4 && (
                  <img
                    src={state.candidate4.localFile}
                    style={imageStyle}
                  />
                )
              }
              <div>
                <input
                  ...
                  onChange={onChangeImage}
                />
                <label htmlFor="file4" style={inputLabelStyle}>Choose a file</label>
              </div>
              <p className="mb-4 mt-6 font-bold">What is the fifth option?</p>
              {
                state.candidate5 && (
                  <img
                    src={state.candidate5.localFile}
                    style={imageStyle}
                  />
                )
              }
              <div>
                <input
                  ...
                  onChange={onChangeImage}
                />
                <label htmlFor="file5" style={inputLabelStyle}>Choose a file</label>
              </div>
            </div>
          </div>
        )
